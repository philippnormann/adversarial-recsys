...
\node [right=of query.south east, rectangle, inner sep=0.5pt, color3, draw, thick] (adv1) {\includegraphics[width=2cm] {../thesis/images/adv/normal-24-epochs/cw/0.03/attack}};
